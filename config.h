...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_b,      spawn,          {.v = (const char*[]){ "newbm", NULL } } },
	...
	{ 0,                            XF86XK_AudioRaiseVolume,   spawn,           SHCMD("pactl set-sink-volume $(pactl get-default-sink) +5%")},
	{ 0,                            XF86XK_AudioLowerVolume,   spawn,           SHCMD("pactl set-sink-volume $(pactl get-default-sink) -5%")},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
